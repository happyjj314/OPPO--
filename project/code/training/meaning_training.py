...
class Sentiment_trainer:
    ...
    def iteration(self,epoch,data_loader,train=True,df_name="df_log_meaning.pickle"):
...
if __name__ == '__main__':
    def init_trainer(dynamic_lr, batch_size=128):
        trainer = Sentiment_trainer(max_len=20,
    ...
    train_epoches = 9999
    trainer, dynamic_lr = init_trainer(dynamic_lr=1e-06, batch_size=128)
